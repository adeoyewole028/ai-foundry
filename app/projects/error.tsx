  ...
  return (
    <main id="main-content" className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      <section className="rounded-xl border border-rule bg-surface p-6">
        <p className="font-mono text-sm font-semibold uppercase text-accent">Projects error</p>
        <h1 className="mt-3 text-3xl font-black tracking-[-0.03em] text-ink">
          We cannot load projects right now.
        </h1>
        <p className="mt-3 text-ink-soft">
          Retry the list, or return to the curriculum and open a project from its module.
        </p>
        {error.message ? (
